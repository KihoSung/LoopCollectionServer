...
public class MySQLConnectionPool
{
	 ...
	 */
	public MySQLConnectionPool(String databaseUrl, String userName, String password, int maxSize)
	{
	 ...
	 *            The connection
	 * @throws SQLException
	 *             When the connection is returned already or it isn't gotten from the pool.
	 */
